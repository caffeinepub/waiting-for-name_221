...
export class Backend implements backendInterface {
    ...
    async createSubject(arg0: string, arg1: string, arg2: string): Promise<void> {
        if (this.processError) {
            try {
    ...
    async getTotalStudyTimePerSubject(arg0: Principal): Promise<Array<[string, bigint]>> {
        if (this.processError) {
            try {
                const result = await this.actor.getTotalStudyTimePerSubject(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getUserStudySessions(arg0: Principal): Promise<Array<StudySession>> {
        if (this.processError) {
            try {
                const result = await this.actor.getUserStudySessions(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async logStudySession(arg0: string, arg1: bigint, arg2: string): Promise<void> {
        if (this.processError) {
            try {
